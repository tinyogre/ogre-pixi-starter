import { StandardGamepadButton } from "./StandardGamepadButton";
import { StandardGamepadEvent } from "./StandardGamepadEvent";
import { StandardGamepadEventHandler } from "./StandardGamepadEventHandler";
import { StandardGamepadMapping } from "./StandardGamepadMapping";
...
export class StandardGamepad {
  ...
  private getConnectedGamepad(): void {
    let gamepad = this.navigator.getGamepads()[0];
    if (gamepad) {
