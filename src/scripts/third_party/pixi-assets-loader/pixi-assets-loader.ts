...
export class PixiAssetsLoader extends EventEmitter {
    ...
    constructor(pixiLoader?: PIXI.Loader) {
        ...
        this.loader = pixiLoader ? pixiLoader : PIXI.Loader.shared;
    ...
    private onGenericAssetProgress(loader: PIXI.Loader, resource: PIXI.loaders.Resource): void {
    ...
    private onGenericAssetError(error: Error, loader: PIXI.Loader, resource: PIXI.LoaderResource): void {
    ...
    private onGenericAssetLoad(loader: PIXI.loaders.Loader, resource: PIXI.LoaderResource): void {
        const loadAsset = this.assetsLoading[resource.name];
